...
const Availability = ({ navigation }: any) => {
  const availabilityPie = [
    { name: "Availability", population: 72, color: "#4CAF50" },
    { name: "Downtime", population: 50, color: "#E53935" },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Availability Analytics</Text>

          <PieChart
            data={availabilityPie}
            width={screenWidth - 60}
            height={170}
            accessor="population"
            backgroundColor="transparent"
            hasLegend={false}
            chartConfig={{ color: () => "#4CAF50" }}
            paddingLeft="0"
          />
          ...
          <View style={styles.legendWrapper}>
            <View style={styles.legendRow}>
              ...
              <Text style={styles.legendValue}>72%</Text>
            </View>

            <View style={styles.legendRow}>
              <View style={[styles.legendDot, { backgroundColor: "#E53935" }]} />
              <Text style={styles.legendText}>Downtime</Text>
              <Text style={[styles.legendValue, { color: "#E53935" }]}>50%</Text>
            </View>
          </View>
        </View>
        ...
        {/* LINE CHART CARD */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Availability Trend</Text>
...
const styles = StyleSheet.create({
  ...
  legendRow: { flexDirection: "row", marginVertical: 4, alignItems: "center", justifyContent: "space-between" },
  ...
  navLabelActive: { fontSize: 12, color: "#4CAF50", fontWeight: "700", marginTop: 4 },
});
